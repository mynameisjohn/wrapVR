...
namespace wrapVR
{
    ...
    public class CurveBetweenTwo
    {
        ...
        Transform _tStart, _tEnd0, _tEnd1;
        ...
        public Vector3 Evaluate(float fX)
        {
            ...
            Vector3 v3Start = _tStart.transform.position;
            Vector3 v3End1 = _tEnd0.transform.position;
            Vector3 v3End2 = _tEnd1.transform.position;

            // The lines from start to p1/2 are straight
            Vector3 p1 = Vector3.Lerp(_tStart.transform.position, v3End1, fX);
